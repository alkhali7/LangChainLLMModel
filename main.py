...
from langchain_community.llms import Ollama  # instead of ChatOpenAI
...
def main():
    ...
    information = """"
        Elon Musk
        Musk in 2022
Senior Advisor to the Presidentarture from the Department of Government Efficiency
    ...
    llm = Ollama(temperature=0, model='llama3')  # using Ollama instead of ChatOpenAI
